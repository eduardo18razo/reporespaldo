...
var OxO113d=["postback","Save"];function doClose(){Window_SetDialogReturnValue(window,null);var OxO181a=[];Window_CloseDialog(window);} ;function CuteEditor_OnCommand(editor,Ox4d,Ox4e,Ox4f){if(Ox4d.toLowerCase()==OxO113d[0]&&Ox4f==OxO113d[1]){Window_SetDialogReturnValue(window,'<%= Request.QueryString["f"]%>');} ;} ;
</script>

<asp:Panel runat=server Visible=false id="savedpanel">
<script language="JavaScript" type="text/javascript" >
var OxO181a=[];Window_CloseDialog(window);
</script>
</asp:Panel>