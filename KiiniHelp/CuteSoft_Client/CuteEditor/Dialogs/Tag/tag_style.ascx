...
var OxO844d=["ondblclick","navtd","shiftKey","style"];Window_GetElement(window,OxO844d[1],true)[OxO844d[0]]=function (){if(event[OxO844d[2]]){alert(element[OxO844d[3]].cssText);} ;} ;
</script>
